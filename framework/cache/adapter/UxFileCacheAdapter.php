 ...
 * @version 0.6
 */
class UxFileCacheAdapter implements IUxCache {
    ...
    public function __construct() {
        $this->cachePath = isset(Ux::$app->config['cache']['path']) ? Ux::$app->config['cache']['path'] : $this->cachePath;
        $this->cachePath = Ux::$app->getBasePath() . DIRECTORY_SEPARATOR . $this->cachePath;
        $this->cacheExt = isset(Ux::$app->config['cache']['ext']) ? Ux::$app->config['cache']['ext'] : $this->cacheExt;
    }
    ...
    public function set($key, $data, $expire = '') {
        ...
        UxFileHelper::mkdir(dirname($fileName));
        //}
    ...
    public function flush() {
        return UxFileHelper::clearDir($this->cachePath);
    }
