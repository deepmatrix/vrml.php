 ...
 * @version 0.6
 */
class UxMemCacheAdapter implements IUxCache
{
	...
	public function __construct()
	{
		...
		{
			throw new UxHttpException('can not find the memcache extension',403);
			exit;
		}

		$this->cache = new Memcache;
		$server = isset(Ux::$app->config['cache']['server']) ? Ux::$app->config['cache']['server'] : $this->defaultHost;
		if(is_array($server))
		{
